 ...
 * created:    2019/10/20
 * <p>
 * {@code RecursiveSquares}  takes an integer command-line argument n and plots a recursive square pattern of order n.
 *
 * The largest square is centered on the canvas and has side length 0.5. The side length of each square is one-half
 * that of the next largest square.
 *
